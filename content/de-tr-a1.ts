            ...
            // ---- Wiederholung (Recycling L1–L7, Festigung) ----
            {
              ...
              content: {
                ...
                turns: [
                  ...
                  { speaker: "Can", text: "Sorun değil, orada — çok yakın! Benim adım Can, memnun oldum. Nasılsın?", translation: "Kein Problem, da drüben — ganz nah! Ich heiße Can, freut mich. Wie geht es dir?" },
                  {
                    speaker: "Du",
                    choices: [
                      { text: "İyiyim, teşekkürler. Sen nasılsın?", correct: true, feedback: "Perfekt – so führst du Smalltalk und fragst zurück." },
                      { text: "Hesap, lütfen!", correct: false, feedback: "„Die Rechnung, bitte“ gehört ins Café, nicht hierher." },
                    ],
                  },
                  { speaker: "Can", text: "Ben de iyiyim, teşekkürler. Bak, bu benim babam, bu da benim ailem.", translation: "Mir auch, danke. Schau, das ist mein Vater und das ist meine Familie." },
                  {
                    speaker: "Du",
                    choices: [
                  ...
                  { speaker: "Can", text: "Ben Türkiye'denim, biraz Almanca biliyorum. Otobüs geldi — hoşça kal!", translation: "Ich komme aus der Türkei und spreche ein bisschen Deutsch. Der Bus ist da — mach's gut!" },
